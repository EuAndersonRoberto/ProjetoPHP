...
<head>
    ...
    <style>
        body {
            ...
            background-image: url(../imagens/fin1.jpg);
        ...
        fieldset {
            border: 3px solid rgb(52, 82, 112);
        }
        ...
        #submit {
            background-image: linear-gradient(to right, rgb(0, 92, 197), rgb(149, 112, 219));
            width: 100%;
            border: none;
            padding: 15px;
            color: white;
        ...
        #submit:hover {
            background-image: linear-gradient(to right, rgb(54, 73, 95), rgb(54, 30, 100));
        }
    </style>
</head>
